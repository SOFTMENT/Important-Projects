...
public class GlideRequests extends RequestManager {
  ...
  protected void setRequestOptions(@NonNull RequestOptions toSet) {
    if (toSet instanceof com.originaldevelopment.wallpaper.GlideOptions) {
      super.setRequestOptions(toSet);
    } else {
      super.setRequestOptions(new com.originaldevelopment.wallpaper.GlideOptions().apply(toSet));
    }
  }
}
