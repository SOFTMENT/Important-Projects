...
public class ChatHomeAdapter extends RecyclerView.Adapter<ChatHomeAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
           ...
           Glide.with(context).load(lastMessageModel.getSenderImage()).diskCacheStrategy(DiskCacheStrategy.DATA).placeholder(R.drawable.placeholder).into(holder.profile_image);
           holder.username.setText(lastMessageModel.getSenderName());
           holder.message.setText(lastMessageModel.getMessage());
           holder.time.setText(Services.getTimeAgo(lastMessageModel.date.getTime()));
        ...
        Log.d("ISREAD",""+lastMessageModel.isRead());
           ...
           holder.view.setOnClickListener(new View.OnClickListener() {
               ...
               public void onClick(View v) {
                   ...
                   intent.putExtra("awayId",lastMessageModel.getSenderUid());
                   intent.putExtra("awayProfile",lastMessageModel.getSenderImage());
                   intent.putExtra("awayName",lastMessageModel.getSenderName());
                   intent.putExtra("awayToken",lastMessageModel.getSenderToken());
