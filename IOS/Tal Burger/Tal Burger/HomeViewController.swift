 ...
 let delegate = UIApplication.shared.delegate as! AppDelegate
   ...
   override func viewDidLoad() {
    ...
    override func viewWillAppear(_ animated: Bool) {
           let urls = URL(string:"https://apps.wixrestaurants.com/?type=wixorders.client.mobile.standalone&restaurantAlias=talburgermz&restaurantSource=&restaurantPlatform=")
